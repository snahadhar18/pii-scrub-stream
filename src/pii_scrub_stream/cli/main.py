"""Command-line interface for pii-scrub-stream (built with Click)."""
...
from pii_scrub_stream import __version__
from pii_scrub_stream.detectors import (
    available_detectors,
    build_detectors,
    default_detectors,
)
from pii_scrub_stream.detectors.base import Detector
from pii_scrub_stream.scrubber.engine import FileResult, RedactionEngine
from pii_scrub_stream.scrubber.redaction import Redactor, label_redactor, make_mask_redactor
...
@click.version_option(__version__, prog_name="pii-scrub")
def cli() -> None:
